...
const Organisasi = () => {
    return (
        <>
            <div id="kandidat" className="flex flex-col items-center justify-center gap-8 bg-[#3c665c] p-4 py-24">
                    ...
                    <>
                        ...
                        <label htmlFor={`modal-${item.name}`} className="modal cursor-pointer">
                            <div className="modal-box max-w-full">
                                <h3 className="pb-4 text-center text-4xl font-bold tracking-[0.1em]">{item.name}</h3>
