      ...
      <footer className="footer bg-base-200 p-10 text-base-content">
        <div>
          ...
          <p>
            PEMILRA FTI UAJY
            <br />
            Dibuat dengan Cinta oleh Mahasiswa FTI sejak 2021
          </p>
        </div>
        <div>
        ...
        <div>
          <span className="footer-title">Contact Person</span>
          <a className="link-hover link">Dog</a>
          <a className="link-hover link">Cat</a>
          <a className="link-hover link">Cobra</a>
          <a className="link-hover link">Conda</a>
        </div>
        <div>
          <span className="footer-title">Lokasi</span>
          <iframe
